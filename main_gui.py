...
class MainWindowControllerDelegate(NSObject):
...
class AppDelegate(NSObject, MainWindowControllerDelegate):
    mainWindowController = objc.ivar()

    def applicationDidFinishLaunching_(self, aNotification):
        if self.mainWindowController is None:
            self.mainWindowController = MainWindowController.alloc().initWithWindowNibName_("MainWindow")
